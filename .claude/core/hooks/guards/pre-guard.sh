...
# Guard against inverted thresholds (warn > block) that would block everything above warn.
(( WARN_THRESHOLD <= BLOCK_THRESHOLD )) || { WARN_THRESHOLD=30; BLOCK_THRESHOLD=70; }
